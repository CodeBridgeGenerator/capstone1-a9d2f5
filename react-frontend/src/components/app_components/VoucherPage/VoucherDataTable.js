...
const inputTextareaTemplate3 = (rowData, { rowIndex }) => <p >{rowData.termsandcondition}</p>
...
<Column field="termsandcondition" header="Termsandcondition" body={inputTextareaTemplate3} filter={selectedFilterFields.includes("termsandcondition")} hidden={selectedHideFields?.includes("termsandcondition")}  sortable style={{ minWidth: "8rem" }} />
